...
we need the countData and colData files to match up so we will need to
remove that odd first column in countData.
...
![](Class15_miniproject_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](Class15_miniproject_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](Class15_miniproject_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](Class15_miniproject_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
> Now, let’s process our results a bit more to automatically pull out
> the top 5 upregulated pathways, then further process that just to get
> the pathway IDs needed by the pathview() function. We’ll use these
...
> Endosomal/Vacuolar Pathway. KEGG results shows quite similar resutls,
> but since the term is a little broader in the GO and the result of
> KEGG is more specific, so its harder to compare the two.
